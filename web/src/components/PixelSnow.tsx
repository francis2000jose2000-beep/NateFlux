...
type PixelSnowSettings = Required<
  Pick<
    PixelSnowProps,
    | "color"
    | "flakeSize"
...
export default function PixelSnow({
  ...
  useEffect(() => {
    ...
    const initialVariantValue = settings.variant === "round" ? 1.0 : settings.variant === "snowflake" ? 2.0 : 0.0;
    const initialThreeColor = new Color(settings.color);
    const initialColorVector = new Vector3(initialThreeColor.r, initialThreeColor.g, initialThreeColor.b);
    ...
    const material = new ShaderMaterial({
      ...
      uniforms: {
        ...
        uFarPlane: { value: settings.farPlane },
        uColor: { value: initialColorVector.clone() },
        uBrightness: { value: settings.brightness },
        uGamma: { value: settings.gamma },
        uDensity: { value: settings.density },
        uVariant: { value: initialVariantValue },
        uDirection: { value: (settings.direction * Math.PI) / 180 },
      },
      transparent: true,
    });
